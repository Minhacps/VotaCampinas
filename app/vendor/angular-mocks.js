 ...
 *
  ```js
    ...
    describe('MyController', function() {
       ...
       // Set up the module
       beforeEach(module('votaCampinas'));
 ...
 *
 * ```js
 *   votaCampinasDev = angular.module('votaCampinasDev', ['votaCampinas', 'ngMockE2E']);
 *   votaCampinasDev.run(function($httpBackend) {
...
!(function(jasmineOrMocha) {
   ...
   * ```js
   *
   *   angular.module('votaCampinaslicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('votaCampinas', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('votaCampinaslicationModule'));
   *
   *
