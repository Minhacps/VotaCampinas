exports.up = function (knex, Promise) {
  return Promise.all([
    ...
    knex('perguntas').insert([
      ...
      {id:16, pergunta:"Agenda pública obrigatória dos compromissos de Prefeit@ e Vereador@s."},
      ...
      {id:20, pergunta:"Fim das coligações eleitorais em eleições para vereadores. [A forma atual permite que as pessoas votem em candidat@s do partido X e elejam candidat@s do partido Y, que pensam diferente.]"},
